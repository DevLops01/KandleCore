Contributing to Kandle Core
============================

The Kandle Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Kandle Core project, and is not to be
confused with overall Kandle Network Protocol consensus changes.

Whether a pull request is merged into Kandle Core rests with the project merge
...
Patches that change Kandle consensus rules are considerably more involved than
...
Where a patch set proposes to change the Kandle consensus, it must have been
...
The project leader is the release manager for each Kandle Core release.
