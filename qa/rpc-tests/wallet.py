...
#   c) node1 mines 32 blocks, so now node 0 has 60001kndl, node 1 has 4250kndl, node2 has none.
#   d) node0 sends 601 kndl to node2, in two transactions (301 kndl, then 300 kndl).
