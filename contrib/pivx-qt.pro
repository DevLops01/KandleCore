...
RESOURCES += src/qt/kandle.qrc src/qt/kandle_locale.qrc

TRANSLATIONS += src/qt/locale/kandle_bg.ts \
                src/qt/locale/kandle_de.ts \
                src/qt/locale/kandle_en.ts \
                src/qt/locale/kandle_es.ts \
                src/qt/locale/kandle_fi.ts \
                src/qt/locale/kandle_fr.ts \
                src/qt/locale/kandle_it.ts \
                src/qt/locale/kandle_ja.ts \
                src/qt/locale/kandle_pl.ts \
                src/qt/locale/kandle_pt.ts \
                src/qt/locale/kandle_ru.ts \
                src/qt/locale/kandle_sk.ts \
                src/qt/locale/kandle_sv.ts \
                src/qt/locale/kandle_vi.ts \
                src/qt/locale/kandle_zh_CN.ts \
                src/qt/locale/kandle_zh_TW.ts
