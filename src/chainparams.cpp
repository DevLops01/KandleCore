...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000f8b1e3d13fc9b96683094e12b380131af19d1b08540ddd0e18f27f420f0"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1565959623, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 13785;
        bnProofOfWorkLimit = ~uint256(0) >> 9; // Kandle starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 45 * 60; // Kandle: 1 day
        nTargetSpacing = 1 * 60;  // Kandle: 1 minute
        nMaturity = 50;
        ...
        nBlockZerocoinV2 = 2147483647; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2019 4:00:00 AM GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "US Treasury Announces Recession Warning!";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1565959623;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 6431692;
        ...
        assert(hashGenesisBlock == uint256("0x00000f8b1e3d13fc9b96683094e12b380131af19d1b08540ddd0e18f27f420f0"));
        assert(genesis.hashMerkleRoot == uint256("0xeb2cd4b7bcbd9a0621619280083ff6333ed10a5e7d578f983748999e45e172b1"));

        vSeeds.push_back(CDNSSeedData("134.209.167.189", "134.209.173.116"));
        vSeeds.push_back(CDNSSeedData("165.22.42.108", "134.209.169.129"));
        vSeeds.push_back(CDNSSeedData("134.209.169.107", "134.209.169.85"));
        ...
        nStartMasternodePayments = 1565959623; //Wed, 25 Jun 2014 20:36:16 GMT
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zkndl to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Kandle: 1 day
        nTargetSpacing = 1 * 60;  // Kandle: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        */
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "kandle-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "kandle-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet kandle addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet kandle script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet kandle BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet kandle BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet kandle BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Kandle: 1 day
        nTargetSpacing = 1 * 60;        // Kandle: 1 minutes
