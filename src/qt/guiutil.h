...
/** Utility functions used by the Kandle Qt UI.
 */
namespace GUIUtil
{
...
// Render Kandle addresses in monospace font
...
// Parse "kandle:" URI into recipient object, return true on successful parsing
