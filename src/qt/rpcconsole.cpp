                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKNDLPathCustom = GetArg("-zkndlbackuppath", "");
    ...
    if(!strzKNDLPathCustom.empty()) {
        ui->wallet_customzkndlbackuppath->setText(QString::fromStdString(strzKNDLPathCustom));
        ui->wallet_customzkndlbackuppath_label->setVisible(true);
        ui->wallet_customzkndlbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKNDLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Kandle RPC console.") + "<br>" +
