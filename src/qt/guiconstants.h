...
/* Kandle GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Kandle"
#define QAPP_ORG_DOMAIN "kandle.me"
#define QAPP_APP_NAME_DEFAULT "Kandle-Qt"
#define QAPP_APP_NAME_TESTNET "Kandle-Qt-testnet"
