...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zkndlTracker->HasMintTx(hash))) {
            //zKNDL stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZKNDL;
...
bool IsZKNDLType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZKNDL:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZKNDL || type == TransactionRecord::MNReward) {
