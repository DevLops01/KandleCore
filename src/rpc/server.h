...
extern UniValue setzkndlseed(const UniValue& params, bool fHelp);
extern UniValue getzkndlseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkndl(const UniValue& params, bool fHelp);
extern UniValue dzkndlstate(const UniValue& params, bool fHelp);
