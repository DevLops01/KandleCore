...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in kandle\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zKNDLsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zKNDL denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zKNDL denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zKNDL denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zKNDL denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zKNDL denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zKNDL denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zKNDL denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zKNDL denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zKNDL denominations\n"
            "  }\n"
            "}\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of kandle addresses\n"
            "     \"kandleaddress\"   	 	(string) kandle address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
