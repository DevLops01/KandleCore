...
In order to support loading of multiple wallets in kandle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kandle.cpp.
...
Changes to kandle.cpp
----------------------
kandle.cpp is the entry point into kandle-qt, and as such, will require some minor modifications to provide hooks for
