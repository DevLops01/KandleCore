...
This mechanism has been integrated into Bitcore-Node-Kandle which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Kandle-Developer/insight-api-kandle#web-socket-api](https://github.com/Kandle-Developer/insight-api-kandle#web-socket-api)
* API: [https://github.com/Kandle-Developer/insight-api-kandle#swifttx-transactions](https://github.com/Kandle-Developer/insight-api-kandle#swifttx-transactions)
...
By default, the Kandle Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Kandle Core daemon:
